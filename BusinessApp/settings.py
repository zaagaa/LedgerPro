...
ACTIVATION_URL="https://activation.ledger.in.net"
...
MIDDLEWARE = [
    ...
    'BusinessApp.middleware.RedirectOnErrorMiddleware',  # ✅ move here
    ...
    'middleware.readonly_protect.ReadOnlyProtectMiddleware',
    'BusinessApp.middleware.SubscriptionCheckMiddleware',
...
# 'BusinessApp.middleware.RedirectOnErrorMiddleware',
#     'BusinessApp.middleware.AutoLockMiddleware',
# 'BusinessApp.middleware.PageLoadTimeMiddleware',
# 'setting.middleware.SettingMiddleware',
# 'middleware.readonly_protect.ReadOnlyProtectMiddleware',
...
if os.getenv('DATABASE_URL'):
    ...
    # === Default offline DB config template ===
    DEFAULT_DB_CONFIG = {
    ...
    # === Create db_config.json if not exists ===
...
DATABASE_ROUTERS = ['middleware.db_router.ReadOnlyRouter']
