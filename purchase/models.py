...
class Payment(models.Model):
    ...
    purchase = models.ForeignKey('Purchase', on_delete=models.DO_NOTHING, null=True, blank=True)
...
class Stock(models.Model):
    ...
    supplier=models.ForeignKey(Supplier, on_delete=models.CASCADE, null=True)
    # purchase=models.ForeignKey('Purchase', on_delete=models.CASCADE, null=True)
    purchase = models.ForeignKey(Purchase, on_delete=models.CASCADE, related_name='stocks', null=True)
...
class PurchaseScan(models.Model):
    purchase = models.ForeignKey('Purchase', on_delete=models.CASCADE, related_name='scans')
