...
def install_global_settings():
    ...
    install_setting(None, "debug_mode", "Disable")
    ...
    install_setting(None, "biometric_device_ip", "192.168.1.201")
    install_setting(None, "biometric_device_port", "4370")
    install_setting(None, "biometric_import_duration", "2")
    install_setting(None, "biometric_import_entry_count", "100")
    install_setting(None, "biometric_clear_limit", "200")
    install_setting(None, "biometric_record_import_hours", "24")
    install_setting(None, "biometric_enable", "0")
    ...
    install_setting(None, "incentive_sale_system", "Disable")
    install_setting(None, "incentive_base_target", 100000)  # Weekly static target
    install_setting(None, "incentive_rate_per_extra_percent", 5)  # ₹5 for each % above 100%
    install_setting(None, "incentive_max_percent", 300)  # Cap at 300%
    install_setting(None, "incentive_base_reward", 200)  # Fixed incentive
    ...
    install_setting(None, "sms_template_id_sms_alert", "1607100000000142158")
    install_setting(None, "sms_template_id_sms_alert_daily_limit", "5000")
    install_setting(None, "sms_template_id_sms_alert_status", "Disable")
    install_setting(None, "sms_template_id_sms_alert_day", "30")
    install_setting(None, "sms_template_id_sms_alert_day_for_deactivated_customer", "0")
    install_setting(None, "sms_template_content_sms_alert",
                    "	Hello {customer_name}, Your Customer Points:  {customer_point}. New Collections Arrived. Visit Us Soon!")
