...
# path('delete/<uuid:id>', views.delete_company, name='delete_company'),
    path('add/', views.company_form_view, name='company_add'),
    path('edit/<uuid:pk>/', views.company_form_view, name='company_edit'),
path('delete/<uuid:pk>/', views.company_delete, name='company_delete'),
path('get_states/', views.get_states, name='get_states'),

    path('company/add/', views.edit_or_add_company, name='company_add'),
    path('company/<uuid:pk>/edit/', views.edit_or_add_company, name='company_edit'),
